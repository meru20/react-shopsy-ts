                ...
                <div className='col'>
                    <div className='page-breadcrumb'>
                        <h4>
                            ...
                            <span><Link to={`/products/${product.id}`}>{product.title}</Link></span>
                        </h4>
                        ...
                        <div className='row'>
                            ...
                            <div className='col-sm-12 col-md-4'>
                                <div className='prod-img-container p-3'>
                                    <div className='prod-img' style={{backgroundImage: `url(${product.image})`}}></div>
                                      ...
                                      <div className='card-cart'>
                                          <div className='row'>
                                              ...
                                              <div className='col-10'>
                                                  <div className='btn btn-block btn-danger'>Add To Cart</div>
                                              </div>
                                          </div>
                                      </div>
                                </div>
